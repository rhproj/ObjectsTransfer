...
В каждой базе присутствует таблица __EFMigrationHistory - это служебная таблица, которую автоматически создаёт Entity Framework для отслеживания миграций базы данных (Хранит историю всех применённых миграций, позволяет откатывать на определенное состояние назад)
